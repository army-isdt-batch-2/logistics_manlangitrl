        ...
        <div class="card">
            <div class="card-body row p-5">
                ...
                <div class="col-2 text-end">
                    <a href="{{route('storage.create')}}" class="btn btn-primary pull-right">Create</a>
                </div>
                <div class="col-12">
                    <hr>
                </div>
                            ...
                            <tr>
                                ...
                                <th scope="col">
                                    <form action="{{ route('storage.destroy', $storage->id) }}" method="post">
                                        @csrf
                                        @method('delete')
                                        <a type="button" href="{{ route('storage.edit', $storage->id) }}" class="btn btn-success btn-sm">Edit</a>
