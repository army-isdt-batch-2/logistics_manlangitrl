    ...
    <div class="col-12 mt-5">
        <div class="card">
            <div class="card-body row p-4">
                ...
                <div class="col-12">
                    <form action="{{route('transportation.update',$data->id)}}" method="post" class="row g-3">
                        @csrf
                        @method('PUT')
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" name="driver_contact" value="{{$data->driver_contact}}"   required>
                        </div>
                        <div class="col-md-6">
                            <label for="name" class="form-label">Notes</label>
                         <textarea  class="form-control" name="notes"
                          required>{{$data->notes}}</textarea>
                        </div>
